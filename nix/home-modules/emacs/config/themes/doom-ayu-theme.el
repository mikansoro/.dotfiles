;;; doom-ayu-theme.el --- inspired by Ayu Dark -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
(defgroup doom-ayu-theme nil
  "Options for the `doom-ayu' theme."
  :group 'doom-themes)
...
(defcustom doom-ayu-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-ayu
  ...
  ((hl-line :background common-line) 
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if doom-ayu-comment-bg (doom-lighten bg 0.05) 'unspecified))
   (font-lock-doc-face
