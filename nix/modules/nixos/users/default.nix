...

{
  ...
  users.users.michael = {
    isNormalUser = true;
    extraGroups = [ "wheel" "docker" "cdrom" "podman" ]; # Enable ‘sudo’ for the user.
    hashedPassword = "$y$j9T$LhwP9FH9wiINgPhisrhRr/$PdVLLbxlavdm2Da2dEopvhcEH8Po7a1n6sQhwtNvy56";
    openssh.authorizedKeys.keys = lib.mkIf (config.mikansoro.machineUsage == "personal") [
      ...
      "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIKpOtZdJ2yECeotPQDyKEHvQjr9Dy+o04m4+l79QeHM5 michael@glaceon"
    ];
    shell = pkgs.zsh;
  };
